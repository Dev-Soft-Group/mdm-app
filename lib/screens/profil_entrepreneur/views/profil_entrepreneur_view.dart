                                      ...
                                      Card(
                                        ...
                                        child: Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                controller.produitsList.length
                                                    .toString()
                                                    .padLeft(2, "0"),
                                                style: const TextStyle(
                                                  color: kPrimaryColor,
                                          ...
                                          controller.publicationStatus ==
                                              ...
                                              : controller.publicationsList
                                                                  ...
                                                                  (index) => Padding(
                                                                      ...
                                                                      child: CardPubItem(
                                                                        liker:
                                                                            () async {
                                                                          await controller
                                                                              .likerPublication(index);
                                                                        },
                                                                        onTap:
                                                                            () {
                                                                          Get.toNamed(
                                                                              AppRoutes.PUBLICATION_DETAIL,
                                                                              arguments: {
                                                                                'idPublication': controller.publicationsList[index].id!
                                                                              });
                                                                        },
                                                                        onLongPress:
                                                                            () {
                                                                          Get.toNamed(
                                                                              AppRoutes.CREATE_PUBLICAION,
                                                                              arguments: {
                                                                                'publication': controller.publicationsList[index]
                                                                              });
                                                                        },
                                                                        onMessage:
                                                                            () async {
                                                                          await controller
                                                                              .sendWhatsAppMessenger(controller.publicationsList[index]);
                                                                        },
                                                                        item: controller
                                                  ...
                                                  : Container(
                                                      ...
                                                      child: Text(
                                                        "Vous n'avez encore aucune publication pour le moment",
                                                        textAlign:
                                                            TextAlign.center,
                                                        style: TextStyle(
                                                            color: kBlackColor
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    (index) => Padding(
                                                                        ...
                                                                        child: CardItem(
                                                                            left: 5,
                                                                            liker: () async {
                                                                              await controller.likerProduit(index);
                                                                            },
                                                                            onLongPress: () {
                                                                              Get.toNamed(AppRoutes.CREATE_PRODUITS, arguments: {
                                                                                "produit": controller.produitsList[index]
                                                                              });
                                                                            },
                                                                            onMessage: () async {
                                                                              await controller.sendWhatsAppMessengerProduit(controller.produitsList[index]);
                                                                            },
                                                                            onTap: () {
                                                                              Get.toNamed(AppRoutes.PRODUITSDETAILS, arguments: {
                                                                                'idProduit': controller.produitsList[index].id!
                                                                              });
                                                                            },
                                                                            item: controller.produitsList[index])),
                                                                  ))))
                                                      : Container(
                                                          height: 270,
                                                          alignment:
                                                          ...
                                                          padding: const EdgeInsets
                                                              ...
                                                              horizontal:
                                                                  kDefaultPadding *
                                                                      1.5),
                                                          child: Text(
                                                            "Vous n'avez encore aucun produit pour le moment",
                                                            textAlign: TextAlign
                                                                .center,
                                                            style: TextStyle(
                                                                color: kBlackColor
                                                            ...
                                                            child: InkWell(
                                                                onLongPress:
                                                                  ...
                                                                  Get.toNamed(
                                                                      ...
                                                                      arguments: {
                                                                        "succursale": controller
                                                                            .entreprise!
                                                                            .succursales![index]
                                                                      });
                                                                },
                                                                child: SuccursaleCard(
                                                                    succursale: controller
                                                                        .entreprise!
                                                                        .succursales![index])),
                                                          )),
                                                  controller.entreprise!
                                                      ...
                                                      ? Container(
                                                          ...
                                                          alignment:
                                                              Alignment.center,
                                                          child: Text(
                                                            "Votre entreprise n'a aucune succursale pour le moment",
                                                            textAlign: TextAlign
                                                                .center,
                                                            style: TextStyle(
                                                                color: kBlackColor
                                                                  ...
                                                                  padding: const EdgeInsets
                                                                      ...
                                                                      horizontal:
                                                                          kDefaultPadding *
                                                                              1.5),
                                                                  child: Text(
                                                                    "Vous n'avez encore aucun service pour le moment",
                                                                    textAlign:
                                                                        TextAlign
                                                                            .center,
                                                                    style: TextStyle(
